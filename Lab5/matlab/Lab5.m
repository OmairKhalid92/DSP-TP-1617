...
%Sizing up lena and the sobel filter matrix
image_size = size(I);
...
%DFT of the two matrices: filter and the image
dft_lena = fft2(double(I), padding_size(1), padding_size(2));
...
inverse_fft = inverse_fft(2:size(I,1)+1, 2:size(I,2)+1);
